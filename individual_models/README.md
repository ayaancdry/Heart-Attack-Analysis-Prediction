This folder contains individual implementations of each model, initially explored and preprocessed in the `eda.ipynb` file, which documents the preprocessing and exploratory data analysis (EDA) steps.
